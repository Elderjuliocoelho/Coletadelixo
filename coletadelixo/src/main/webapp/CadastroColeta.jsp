			...
			<div class="form-container">
    			...
    			<div class="form-social">
					...
					<a href="#" class="social-icon">
     				...
     				<select name="moradores_id"id="moradores_id"class="morador"required>
							<option value="">ID</option>
						</select>
						<select class="tipolixo"required>
							<option value="">Tipo lixo</option>
						</select>
						<select class="localdescarte"required>
