...
<%
  Dao<Coleta,Integer> dao = new Dao<Coleta,Integer>();
...
<table class="table">
    ...
    <%for(Coleta coleta:coletas){ %>
    	<tr>
    		<td><%=coleta.getId() %></td>
    		<td><%=coleta.getMorador().getNome() %></td>
    		...
    		<td>
    			<a class="btn btn-secondary btn-sm"id="excluir" href="<%= request.getContextPath() %>/controllerColeta?id=<%=coleta.getId()%>">Excluir</a>
    		</td>
    	</tr>
    	<%} %>
    </tbody>
