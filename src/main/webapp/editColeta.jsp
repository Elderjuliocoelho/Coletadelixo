...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqFcBUnqwsrl0W0YozcLDQU4xHKn3J_eqnrQ&amp;usqp=CAU">
    ...
    margin-top: -9px;
    padding: -10px;">
    	<input type="hidden" name="coletaid" value="<%=coletaid%>">
        <input class="morador"type="text" value="<%=conColeta.getMorador().getNome() %>"disabled>
		<input type="hidden" name="idMorador"value="<%= conColeta.getMorador().getId() %>">
		<select class="tipolixo" name="tipolixo">
		<%
		...
		<input class="tipo"type="text" name="peso" value="<%=conColeta.getPeso() %>"/>
		<br>
